...
def Deadlift_Starting_Message(): 
 ...
 st.audio('App\AudioCoach\Messages\Starting_Deadlift_Message.mp3',  autoplay= True)
...
def Leg_Lunges_Starting_Message(): 
 ...
 st.audio('App\AudioCoach\Messages\Starting_Leg_Lunges_Message.mp3',  autoplay= True)
...
def Hamstring_Curls_Starting_Message():
  ...
  st.audio('App\AudioCoach\Messages\Starting_Hamstring_Curls_Message.mp3',  autoplay= True)
...
def Congratulation_Message():
  ...
  st.audio('App\AudioCoach\Messages\Congratulation_Message.mp3',  autoplay= True)
...
def Go_Up_Message():
  ...
  st.audio('App\AudioCoach\Messages\Go Up Message.mp3',  autoplay= True)
...
def Bicep_Curls_Starting_Message():
  ...
  st.audio('App\AudioCoach\Messages\Starting_Bicep_Curls_Message.mp3',  autoplay= True)
...
def Drag_Curls_Starting_Message():
  ...
  st.audio('App\AudioCoach\Messages\Starting_Drag_Curls_Message.mp3',  autoplay= True)
...
def Hammer_Curls_Starting_Message():
  ...
  st.audio('App\AudioCoach\Messages\Starting_Hammer_Curls_Message.mp3',  autoplay= True)
...
def Pushups_Starting_Message():
  ...
  st.audio('App\AudioCoach\Messages\Starting_Pushups_Message.mp3',  autoplay= True)
...
def Bench_Press_Starting_Message():
  ...
  st.audio('App\AudioCoach\Messages\Starting_Bench_Press_Message.mp3',  autoplay= True)
...
def Dumbbbell_Chest_Flys_Starting_Message():
  ...
  st.audio('App\AudioCoach\Messages\Starting_Dumbbell_Chest_Flys_Message.mp3',  autoplay= True)
...
def Lat_Pulldown_Starting_Message():
  ...
  st.audio('App\AudioCoach\Messages\Starting_Lat_Pulldown_Message.mp3',  autoplay= True)
...
def Arnold_Shoulder_Press_Starting_Message():
  ...
  st.audio('App\AudioCoach\Messages\Starting_Arnold_Shoulder_Presses_Message.mp3',  autoplay= True)
...
def Spider_Curls_Starting_Message():
  ...
  st.audio('App\AudioCoach\Messages\Starting_Spider_Curls_Message.mp3',  autoplay= True)
